...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/*sidebar*/}
      <div
        className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} fixed lg:relative lg:translate-x-0 h-full shadow-lg transition-transform duration-300 bg-background/50 border-b backdrop-blur z-45`}
      >
        <div className="flex flex-col h-full p-4">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className={`w-full flex items-center gap-2 ${selectedPage === "orders" ? "bg-gray-500" : ""}`}
            >
            ...
            <Button
              ...
              className={`w-full flex items-center gap-2 ${
                selectedPage === "inventory" ? "bg-gray-500" : ""
              }`}
            >
